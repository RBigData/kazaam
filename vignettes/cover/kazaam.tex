...
\begin{pspicture}(0,13.5)(\linewidth,0)
  \rput[b]{0}(9.5,-2.8){\includegraphics[scale=.8]{logo/logo.jpg}}
  ...
  \rput[l](0,-6.8){\textsl{\huge Don't get all hysterical! Say thank you for your miracle!}}
  \psline[linewidth=3mm,linecolor=black](0,-3)(\linewidth,-3)
  \psline[linewidth=3mm,linecolor=black](0,-6)(\linewidth,-6)
  \rput[l](0,-4.5){\psscaleboxto(\textwidth,2){Guide to the kazaam Package}}
\end{pspicture}
